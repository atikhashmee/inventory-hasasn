...
class MenufactureController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('menufactures.index')
    ...
    {
        return view('menufactures.create');
    }
    ...
    public function store(CreateMenufactureRequest $request)
    {
        ...
        return redirect(route('menufactures.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('menufactures.show')->with('menufacture', $menufacture);
    }
    ...
    public function edit($id)
    {
        ...
        return view('menufactures.edit')->with('menufacture', $menufacture);
    }
